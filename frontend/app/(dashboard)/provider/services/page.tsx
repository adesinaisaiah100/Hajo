  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#111827]">My Services</h1>
      ...
      {services.length > 0 ? (
        <div className="grid gap-4">
          {services.map((service) => (
            <div
              key={service.id}
              className="flex items-center justify-between rounded-2xl border border-[#e5e7eb] bg-white p-5 shadow-sm"
            >
              <div>
                ...
                <div className="mt-3 flex items-center gap-4 text-sm font-medium text-[#111827]">
