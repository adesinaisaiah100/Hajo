    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl border border-[#e5e7eb] bg-white p-5">
          ...
          <p className="mt-2 text-2xl font-bold text-[#111827]">96%</p>
        </div>
        <div className="rounded-2xl border border-[#e5e7eb] bg-white p-5">
          <div className="flex items-center gap-2 text-[#6b7280]">
          ...
          <p className="mt-2 text-2xl font-bold text-[#111827]">42%</p>
        </div>
        <div className="rounded-2xl border border-[#e5e7eb] bg-white p-5">
          <div className="flex items-center gap-2 text-[#6b7280]">
          ...
          <p className="mt-2 text-2xl font-bold text-[#111827]">₦24,500</p>
        </div>
        <div className="rounded-2xl border border-[#e5e7eb] bg-white p-5">
          <div className="flex items-center gap-2 text-[#6b7280]">
          ...
          <p className="mt-2 text-2xl font-bold text-[#111827]">15m</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <SectionCard title="Revenue Overview">
          <div className="mb-4">
            ...
            <span className="ml-2 text-sm text-[#10b981]">All time</span>
          </div>
        ...
        <SectionCard title="Jobs Overview">
          <div className="mb-4">
            ...
            <span className="ml-2 text-sm text-[#10b981]">Total completed</span>
          </div>
        ...
        <SectionCard title="Top Services by Revenue">
          <div className="space-y-5">
            {topServices.map((service, index) => (
              <div key={index}>
                <div className="flex justify-between text-sm font-medium text-[#111827]">
        ...
        <SectionCard title="Customer Geography">
          <div className="space-y-4">
            {geographies.map((geo, index) => (
              <div key={index} className="flex items-center justify-between border-b border-[#f3f4f6] pb-3 last:border-0 last:pb-0">
