...
export function VerificationBanner() {
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-[#ecfdf5] px-6 py-2.5 sm:px-3.5 sm:before:flex-1 border-b border-[#d1fae5]">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <Link
          ...
          className="flex-none rounded-full bg-[var(--color-brand)] px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-[var(--color-brand-strong)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-brand)] transition flex items-center gap-1"
        >
      ...
      <div className="flex flex-1 justify-end">
        <button type="button" onClick={() => setIsDismissed(true)} className="-m-3 p-3 focus-visible:outline-offset-[-4px]">
          ...
          <X className="h-5 w-5 text-[#047857]" aria-hidden="true" />
        </button>
      </div>
    </div>
  );
